...
-- + INSERT OR IGNORE INTO dbl_table(label, num) VALUES('Chris', 777.000000)
-- + INSERT OR IGNORE INTO dbl_table(num, label) VALUES(2, '2')
-- + INSERT OR IGNORE INTO Caa(id, dl, uid, name, num) VALUES(1, 1, 777.000000, 'Chris', 1)
-- + INSERT OR IGNORE INTO Caa(id, dl, uid, name, num) VALUES(2, 2, 777.000000, 'Chris', 2)
...
-- + INSERT OR IGNORE INTO dbl_table(num, label) VALUES(777.000000, '1')
-- + INSERT OR IGNORE INTO dbl_table(num, label) VALUES(2, '2')
-- + INSERT OR IGNORE INTO Caa(uid, id, dl, name, num) VALUES(777.000000, 1, 1, '1', 1)
-- + INSERT OR IGNORE INTO Caa(id, dl, uid, name, num) VALUES(2, 2, 777.000000, '2', 2)
...
-- + INSERT OR IGNORE INTO dbl_table(num, label) VALUES(-0.100000, '1')
-- + INSERT OR IGNORE INTO dbl_table(num, label) VALUES(2, '2')
...
-- + INSERT OR IGNORE INTO experiment_value(config, logging_id, type, param, value) VALUES('rtc_overlayconfig_exampleconfig', '1234', 9223372036854775807L, 'enabled', '0')
-- + INSERT OR IGNORE INTO experiment_value(config, logging_id, type, param, value) VALUES('rtc_overlayconfig_exampleconfig', '5678', 9223372036854775807L, 'some_integer', '42')
...
begin
  insert into Caa values (1, 1.1, 10, "asdf", "Antonia", 0L);
end;
