...
LET n_i := nullable(1);  -- nullable intege variable initialized to 1
LET l_i := nullable(1L);  -- nullable intege variable initialized to 1
...
-- variables/columns of type distance incompatible with variables of type time
-- variables/columns of types job_id incompatible with person_id
