...
In general, macros _can_ be used (as in C and C++), especially small ones, but it gets to be a worse idea
as the macro grows.  For larger cases, C and C++ provide inline functions -- CQL provides expression fragments.