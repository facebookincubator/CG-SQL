...
### CQL0385: switch statement has only an ELSE clause

The switch statement is empty except for an `ELSE` clause.  This makes the SWITCH
totally redundant.  Probably more cases need to be added or else get rid of the
`SWITCH entirely`.
