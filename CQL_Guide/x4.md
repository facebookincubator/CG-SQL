...
### CQL0299: cursor has too few fields, 'cursor_name'

The cursor was used in a fetch statement but the number of columns fetched is smaller than the number required by the statement we are processing.
...
The cursor with too few fields might be the source or the target of the statement.
