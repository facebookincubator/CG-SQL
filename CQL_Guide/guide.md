...
Snapshot as of Tue Aug  4 13:24:45 PDT 2020
...
NOTE: REGEXP is not supported in CQL
...
OBJECT TEXT BLOB LONG_ INTEGER LONG_INTEGER REAL ON UPDATE CASCADE ON_CONFLICT DO NOTHING
...
FUNC PROC BEGIN_ OUT INOUT CURSOR CURSOR_FOR DECLARE FETCH LOOP LEAVE CONTINUE
...
explain_stmt: "EXPLAIN" explain_op explain_target  
  ; 
...
set_stmt: "SET" name "ASSIGN" expr    
  ; 
 
version_attrs_opt_recreate: "@RECREATE"  
  | "@RECREATE" '(' name ')'   
  | version_attrs  
  ; 
 
version_attrs: /* nil */  
  | "@CREATE" version_annotation version_attrs  
  | "@DELETE" version_annotation version_attrs  
  ; 
...
fk_target_options : "REFERENCES" name '(' name_list ')' fk_options  
  ; 
...
declare_func_stmt: "DECLARE" "FUNC" name '(' params ')' data_type_opt_notnull  
  | "DECLARE" "SELECT" "FUNC" name '(' params ')' data_type_opt_notnull  
  | "DECLARE" "FUNC" name '(' params ')' "CREATE" creation_type  
  | "DECLARE" "SELECT" "FUNC" name '(' params ')' '(' typed_names ')'  
  ; 
 
declare_proc_stmt: "DECLARE" "PROC" name '(' params ')'  
  | "DECLARE" "PROC" name '(' params ')' '(' typed_names ')'  
  | "DECLARE" "PROC" name '(' params ')' "USING" "TRANSACTION"  
  | "DECLARE" "PROC" name '(' params ')' "OUT" '(' typed_names ')'  
  | "DECLARE" "PROC" name '(' params ')' "OUT" '(' typed_names ')' "USING" "TRANSACTION"  
  | "DECLARE" "PROC" name '(' params ')' "OUT" "UNION" '(' typed_names ')'  
  | "DECLARE" "PROC" name '(' params ')' "OUT" "UNION" '(' typed_names ')' "USING" "TRANSACTION"  
  ; 
 
create_proc_stmt: "CREATE" "PROC" name '(' params ')' "BEGIN" opt_stmt_list "END"  
  ; 
...
### CQL0280: upsert statement require a where statement if the insert statement has a select statement
...
### CQL0320: extension fragment CTE must have a FROM clause an no other top level clauses 'frag_name'
