...
// this can only be invoked when re-processing statements
// in a loop context becasue it's generated by rewrite
// exclusively.  If we see this we're already good to go.
...
// this can only be invoked when re-processing statements
// in a loop context because it's generated by rewrite
// exclusively.  If we see this we're already good to go.
