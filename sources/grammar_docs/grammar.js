...
// Snapshot as of Wed Oct  7 12:37:44 2020
...
module.exports = grammar({
  ...
  rules: {
    ...
    cursor_arguments: $ => choice(seq($.FROM, $.name), seq($.FROM, $.name, $.LIKE, $.name)),
    ...
    values: $ => choice(seq('(', $.insert_list, ')'), seq('(', $.insert_list, ')', ',', $.values)),
