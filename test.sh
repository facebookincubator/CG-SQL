...
code_gen_c_test() {
  ...
  on_invalid_sig_exit ${OUT_DIR}/cg_test_c.h
  on_invalid_sig_exit ${OUT_DIR}/cg_test_c.c
  ...
  on_invalid_sig_exit ${OUT_DIR}/cg_test_c_with_type_getters.h
  on_invalid_sig_exit ${OUT_DIR}/cg_test_c_with_type_getters.c
  ...
  if ! ${CQL} --test --cg ${OUT_DIR}/cg_test_c_with_namespace.h ${OUT_DIR}/cg_test_c_with_namespace.c ${OUT_DIR}/cg_test_imports_with_namespace.ref --in ${TEST_DIR}/cg_test.sql --global_proc cql_startup --generate_copy --c_include_namespace test_namespace --generate_exports 2>${OUT_DIR}/cg_test_c.err
  then
    echo "ERROR:"
    cat ${OUT_DIR}/cg_test_c.err
    failed
  ...
  on_invalid_sig_exit ${OUT_DIR}/cg_test_c_with_namespace.h
  on_invalid_sig_exit ${OUT_DIR}/cg_test_c_with_namespace.c
  ...
  on_invalid_sig_exit ${OUT_DIR}/cg_test_extension_fragment_c.c
  on_invalid_sig_exit ${OUT_DIR}/cg_test_extension_fragment_c.h
  on_invalid_sig_exit ${OUT_DIR}/cg_test_assembly_query_c.c
  on_invalid_sig_exit ${OUT_DIR}/cg_test_assembly_query_c.h
...
code_gen_java_test() {
  ...
  if ! ${CQL} --test --cg ${OUT_DIR}/cg_test_extension_fragment_java.out --in ${TEST_DIR}/cg_test_extension_fragment.sql --rt java --java_package_name com.facebook.cqlviewmodels --java_assembly_query_classname com.facebook.cqlviewmodels.cg_test_assembly_query_java 2>${OUT_DIR}/cg_test_java.err
  then
    echo "ERROR:"
    cat ${OUT_DIR}/cg_test_java.err
    failed
  ...
  on_invalid_sig_exit ${OUT_DIR}/cg_test_extension_fragment_java.out
  on_invalid_sig_exit ${OUT_DIR}/cg_test_assembly_query_java.out
...
code_gen_objc_test() {
  ...
  on_invalid_sig_exit ${OUT_DIR}/cg_test_extension_fragment_objc.out
  on_invalid_sig_exit ${OUT_DIR}/cg_extension_fragment_with_core_base_test_objc.out
  on_invalid_sig_exit ${OUT_DIR}/cg_test_assembly_query_objc.out
...
schema_migration_test() {
  ...
  __on_xdiff_exit ${OUT_DIR}/cg_test_schema_prev.out ${OUT_DIR}/prev_twice.out
  __on_xdiff_exit ${OUT_DIR}/prev_twice.out ${OUT_DIR}/prev_thrice.out
...
misc_cases() {
  ...
  if ${CQL} --test --cg ${OUT_DIR}/__temp.out --in ${TEST_DIR}/cg_test_extension_fragment.sql --rt java --java_package_name com.facebook.cqlviewmodels 2>${OUT_DIR}/java_classname_missing.err
  then
  ...
  if ${CQL} --test --cg ${OUT_DIR}/__temp.out --in ${TEST_DIR}/cg_test_extension_fragment.sql --rt java --java_package_name com.facebook.cqlviewmodels --java_assembly_query_classname 2>${OUT_DIR}/java_classname_noargs.err
  then
...
query_plan_test() {
  ...
  if ! ./json_check.py <${OUT_DIR}/cg_test_query_plan_view.out  >${OUT_DIR}/cg_test_query_plan_js.out 2>${OUT_DIR}/cg_test_query_plan_js.err
  then
